package pf::Authentication::Source::CobotSource;

=head1 NAME

pf::Authentication::Source::CobotSource
...
sub dynamic_routing_module { 'Authentication::OAuth::Cobot' }
