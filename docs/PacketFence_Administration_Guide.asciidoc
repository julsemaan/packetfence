...
First create a guest SSID with the guest access you want to use (Email, Sponsor or SMS) and check Add user on email registration amd/or
Add user on sponsor registration in Configuration -> Self Registration section.
At the end of the guest registration, PacketFence will send a an email with the credentials for Email and Sponsor. For SMS use your
