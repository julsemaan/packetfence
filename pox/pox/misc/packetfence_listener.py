...
class PacketFenceListener (object):
  def __init__ (self, connection):
    ...
    # Use this to keep the info about what is discovered in memory
    self.mac_to_port = {}
    self.macs = {} 
    self.ports = {}
  ...
  # This would authorize it by asking pf for the VLAN.
  # Switch crashes when doing this for now (use Python 2.7?)
...
def launch ():
  ...
  def start_switch (event):
    ...
    PacketFenceListener(event.connection)
